...
export const ipServerQuestions: QuestionCollection = [
  {
    name: "local",
    type: "list",
...
export const oscTargetQuestion: QuestionCollection = [
  {
    name: "oscTarget",
    type: "list",
    loop: "false",
...
export const oscTargetIpAndPortQuestion: QuestionCollection = [
  {
...
export const confirmBootstrapQuestions: QuestionCollection = [
